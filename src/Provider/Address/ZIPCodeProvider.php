...
class ZIPCodeProvider
{
     ...
     * @see https://i18napis.appspot.com/address
     */
    public const FRENCH_ZIP_CODE_REGEX = '^(?:[0-8]\d|9[0-8])\d{3}$';

    private const COUNTRIES_ZIP_CODES = [
        "FR" => self::FRENCH_ZIP_CODE_REGEX,
    ...
    {
        return self::COUNTRIES_ZIP_CODES[$countryCode] ?? self::FRENCH_ZIP_CODE_REGEX;
    }
}
